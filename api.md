...
| Method | Path                                        | Description                                                 |
| ------ | ------------------------------------------- | ----------------------------------------------------------- |
| GET    | `/api/people`                               | List of `{name, count, thumbnail_url, section, branch, email, arabic_name, home_zone_id, shift}`.    |
